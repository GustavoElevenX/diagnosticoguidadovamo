...
export async function startDiagnostic(payload = {}) {
  ...
  const intro = `Oi, ${leadName.split(' ')[0]}. Vou criar seu Mapa de Vazamento de Vendas. Minha funcao e identificar, em poucos minutos, onde sua operacao comercial pode estar deixando vendas escaparem antes do fechamento.`;
