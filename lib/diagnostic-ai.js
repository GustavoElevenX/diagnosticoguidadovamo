  ...
  try {
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `Você é a IA de Performance Comercial da VAMO. Gere um insight curto, consultivo e direto em português brasileiro. Não venda a plataforma. Não use markdown. Fique estritamente em gestão comercial, meta, comissão, previsibilidade, follow-up e correção de vendedores.${recentLearning ? `\n\nAprendizados recentes internos:\n${recentLearning}` : ''}`,
        },
        {
          role: 'user',
...
Sua função é gerar o relatório final do Raio-X de Vazamento Comercial VAMO.
Você não é uma IA genérica. Atue exclusivamente em performance comercial, gestão de vendas, comissão, metas, acompanhamento, previsibilidade, follow-up e correção de vendedores.
